...
#   Address:
    ...
    button_ViewHistory_AssignWorkOrder_Adr = "/html/body/app-root/app-workorderassign/section[2]/div/div[2]/div/div[1]/div/button"



    button_PLUSNEW_AssignWorkOrder_Adr = "/html/body/app-root/app-workorderassign/section[2]/div/div[2]/div/div[2]/div[3]/div[1]/div/button"
    ...
    sort_workOrderHistory_AssignWorkOrderAdr = "/html/body/app-root/app-workorderassign/section[2]/div/div[2]/div/div[2]/div[3]/div[2]/dx-data-grid/div/div[5]/div/table/tbody/tr/td[1]"
    ...
    "/html/body/app-root/app-workorderassign/section[2]/div/div[2]/div/div[2]/div[3]/div[1]/h3"
    description_WorkOrderHistory_AssignWorkOrderAdr = "/html/body/app-root/app-workorderassign/section[2]/div/div[2]/div/div[2]/div[3]/div[2]/dx-data-grid/div/div[6]/div/div/div[1]/div/table/tbody/tr[1]/td[4]"
    creationDate_WorkOrderHistory_AssignWorkOrderAdr = "/html/body/app-root/app-workorderassign/section[2]/div/div[2]/div/div[2]/div[3]/div[2]/dx-data-grid/div/div[6]/div/div/div[1]/div/table/tbody/tr[1]/td[1]"
...
#   Page Title on TCReport
    function_Name = "Assign Work Order VENDOR Flow"
...
#   Verify if is the Correct page:
    test_Name = "Assign WO open"
...
#
#   Verify Assign Work Order email page STATUS:
# If STATUS = OPEN:
    #try:
    if input_Status_WorkOrder_WorkOrderPage == "Open":
        ...
        #       Print Assert OK
        print_Information_Fix = "Vendor accepted Work Order"
        print_Information_Var = workOrderNumber_AssignWorkOrder_Read
        test_Case_Type = ""
        contol_Reportfile = 1
        tc_reports.write_reportfile(contol_Reportfile, print_Information_Fix, print_Information_Var, test_Case_Type, driver_Name, driver_Version)
        ...
        print('WO assigned')
        #       Print Assert OK
        print_Information_Fix = "Work Order Assigned"
        print_Information_Var = workOrderNumber_AssignWorkOrder_Read
        test_Case_Type = ""
        contol_Reportfile = 1
        tc_reports.write_reportfile(contol_Reportfile, print_Information_Fix, print_Information_Var, test_Case_Type, driver_Name, driver_Version)
        w1.until(EC.element_to_be_clickable((By.XPATH, button_ViewHistory_AssignWorkOrder_Adr))).click()
