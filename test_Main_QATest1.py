...
import test_Log_Books_ManagePage_apolloWebPortal
import test_Unidentified_Logs_ManagePage_apolloWebPortal
import test_Log_Edits_ManagePage_apolloWebPortal
import test_Dashboard_Compliance_ManagePage_apolloWebPortal
import test_Dashboard_Hours_of_Service_ManagePage_apolloWebPortal
import test_Violations_ManagePage_apolloWebPortal
import test_Enhanced_IFTAPage_apolloWebPortal
import test_Driver_Records_ManagePage_apolloWebPortal
import test_FMCSA_Records_ManagePage_apolloWebPortal
import test_Shipments_ManagePage_apolloWebPortal
import test_Engine_Diagnostic_ManagePage_apolloWebPortal
import test_Driver_Duty_Report_ManagePage_apolloWebPortal
import test_Billing_ManagePage_apolloWebPortal
import test_Billing_Report_ManagePage_apolloWebPortal
import tc_reports
import test_Global_Variables_apolloWebPortal
...
"""
####################################################################################
user_ApolloWebPortalListVar = ["apollo.test.master.reseller",
                               "QA_MasterReseller",
                               "QA_MasterReseller",
                               "QA_MasterReseller",
                               "qauser5"]
...
#    test_Administration_Users_MasterReseller_ManagePage_apolloWebPortal.Administration_Users_MasterReseller_ManagePage(driver, driver_Name, driver_Version, carrier, truckDriversList,siteAddressVar)
...
#    test_Administration_Roles_ManagePage_apolloWebPortal.Administration_Roles_ManagePage(driver, driver_Name, driver_Version, carrier, truckDriversList)
    """
    test_Log_Books_ManagePage_apolloWebPortal.Log_Books_ManagePage(driver, driver_Name, driver_Version, carrier)
    test_Unidentified_Logs_ManagePage_apolloWebPortal.Unidentified_Logs_ManagePage(driver, driver_Name, driver_Version, carrier)
    test_Log_Edits_ManagePage_apolloWebPortal.Log_Edits_ManagePage(driver, driver_Name, driver_Version, carrier)
    test_Dashboard_Compliance_ManagePage_apolloWebPortal.Dashboard_Compliance_ManagePage(driver, driver_Name, driver_Version, carrier)
    test_Dashboard_Hours_of_Service_ManagePage_apolloWebPortal.Dashboard_Hours_of_Service_ManagePage(driver, driver_Name, driver_Version, carrier)
    test_Violations_ManagePage_apolloWebPortal.Violations_ManagePage(driver, driver_Name, driver_Version, carrier)
#    ##############test_Enhanced_IFTAPage_apolloWebPortal.EnhancedIFTA_ManagePage (driver, driver_Name, driver_Version, carrier, truckDriversList)
    test_Driver_Records_ManagePage_apolloWebPortal.Driver_Records_ManagePage(driver, driver_Name, driver_Version, carrier)
    test_FMCSA_Records_ManagePage_apolloWebPortal.FMCSA_Records_ManagePage(driver, driver_Name, driver_Version, carrier)
    test_Shipments_ManagePage_apolloWebPortal.Shipments_ManagePage(driver, driver_Name, driver_Version, carrier)
    test_Engine_Diagnostic_ManagePage_apolloWebPortal.Engine_Diagnostic_ManagePage(driver, driver_Name, driver_Version, carrier)
    test_Driver_Duty_Report_ManagePage_apolloWebPortal.Driver_Duty_Report_ManagePage(driver, driver_Name, driver_Version, carrier)
    test_Billing_ManagePage_apolloWebPortal.Billing_ManagePage(driver, driver_Name, driver_Version, carrier)
    test_Billing_Report_ManagePage_apolloWebPortal.Billing_Report_ManagePage(driver, driver_Name, driver_Version, carrier)
    """
    #driver.close()
