...
def WorkOrder_Flow_ManagePage (driverModelTestControl, driver, driver_Name, driver_Version, carrier, truckDriversList, driver_UserName_Var, client_Name_Var, client_Adress_Var, defect_Vehicle_List_Var, workOrder_CreatedBy_Var, workOrder_Contacts_List):
    ...
    button_Manage_ManageWorkOrderPageAdr = "/html/body/app-root/app-main/div/div/breadcrumb/section/div/div/div[2]/ol/li[1]"
    ...
    sort_WorkOrderNumber_WorkOrderPageAdr = "/html/body/app-root/app-main/div/div/app-manageworkorder/section/div/div/div/div[2]/dx-data-grid/div/div[5]/div/table/tbody/tr/td[1]"
    workOrderNumber_InTest_WorkOrder_ManageWorkOrderAdr_Init = "/html/body/app-root/app-main/div/div/app-manageworkorder/section/div/div/div/div[2]/dx-data-grid/div/div[6]/div/div/div[1]/div/table/tbody/tr["
    ...
    input_sort_WorkOrderNumber_WorkOrder_WorkOrderPageAdr = "/html/body/app-root/app-main/div/div/app-manageworkorder/section/div/div/div/div[2]/dx-data-grid/div/div[6]/div/div/div[1]/div/table/tbody/tr[1]/td[1]"
    input_Status_WorkOrder_WorkOrderPageAdr = "/html/body/app-root/app-main/div/div/app-manageworkorder/section/div/div/div/div[2]/dx-data-grid/div/div[6]/div/div/div[1]/div/table/tbody/tr[1]/td[2]"
    buttoneye_workOrderNumber_InTest_WorkOrder_ManageWorkOrderAdr_Init = "/html/body/app-root/app-main/div/div/app-manageworkorder/section/div/div/div/div[2]/dx-data-grid/div/div[6]/div/div/div[1]/div/table/tbody/tr["
...
#       Calendar Start-End date
    ...
    #       Try ifthe last weekday is in the 7th Row of the calendar
    try:
        w.until(EC.element_to_be_clickable((By.XPATH, day_1st7ColumPosition_Calendar_WorkOrderPageCol))).click()
