#               Apollo Web Portal - FMCSA RECORDS

def FMCSA_Records_ManagePage (driver, driver_Name, driver_Version, carrier):
    ...
    button_FMCSA_Records_ManagePageAdr = test_Global_Addresses_apolloWebPortal.button_FMCSARecords_ManagePageAdr_Global
    title_FMCSA_Records_FMCSA_Records_PageAdr = test_Global_Addresses_apolloWebPortal.title_FMCSA_Records_FMCSA_Records_PageAdr_Global
...
#   Page Title on TCReport
    function_Name = "FMCSA RECORDS page"
...
#       Function Log Books side bar button click
    ...
    button_FMCSA_Records_ManagePage = WebDriverWait(menuRegion_MainSideBar_ManagePageAsideDiv, 10).until(EC.element_to_be_clickable((By.XPATH, button_FMCSA_Records_ManagePageAdr))).click()
    time.sleep(3)

#       Title of the right page
    title_FMCSA_Records_FMCSA_Records_Page = w.until(EC.presence_of_element_located((By.XPATH, title_FMCSA_Records_FMCSA_Records_PageAdr))).text
    test_Name = "FMCSA Records page open"
    condition1 = "FMCSA Records"
    condition2 = title_FMCSA_Records_FMCSA_Records_Page
    tc_reports.assert_test_reportfile(test_Name, condition1, condition2, driver, driver_Name)
    #       Print Assert OK
    print_Information_Fix = "FMCSA Records Page - FMCSA Records page open:"
    print_Information_Var = title_FMCSA_Records_FMCSA_Records_Page
    test_Case_Type = ""
    contol_Reportfile = 1
