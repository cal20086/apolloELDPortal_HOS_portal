...
def WorkOrder_ManagePage (driver, driver_Name, driver_Version, carrier, truckDriversList, driver_UserName_Var, client_Name_Var, client_Adress_Var, defect_Vehicle_List_Var, workOrder_CreatedBy_Var, workOrder_Contacts_Var):
    ...
    title_WorkOrder_WorkOrderPageAdr = "/html/body/app-root/app-main/div/div/breadcrumb/section/div/div/div[1]/h1"
    ...
    # Clock
    button_calendar_WorkOrderPage = "/html/body/app-root/app-main/div/div[1]/app-manageworkorder/section/div/app-search-panel/div/div/form/div[1]/div[4]/app-date-rangepicker/div/div/div/button"
    button_calendar_StartEndDate_WorkOrderPageAdr = "/html/body/app-root/app-main/div/div/app-manageworkorder/section/div/app-search-panel/div/div/form/div[1]/div[4]/app-date-rangepicker/div/div/div/button"
    calendar_Month_WorkOrderPageAdr = "/html/body/app-root/app-main/div/div[1]/app-manageworkorder/section/div/app-search-panel/div/div/form/div[1]/div[4]/app-date-rangepicker/div/div/ngb-datepicker/div[1]/ngb-datepicker-navigation/ngb-datepicker-navigation-select/select[1]"
    ...
    calendar_Year_WorkOrderPageAdr = "/html/body/app-root/app-main/div/div[1]/app-manageworkorder/section/div/app-search-panel/div/div/form/div[1]/div[4]/app-date-rangepicker/div/div/ngb-datepicker/div[1]/ngb-datepicker-navigation/ngb-datepicker-navigation-select/select[2]"
    calendar_DayStart_WorkOrderPageAdr = "/html/body/app-root/app-main/div/div[1]/app-manageworkorder/section/div/app-search-panel/div/div/form/div[1]/div[4]/app-date-rangepicker/div/div/ngb-datepicker/div[2]/div[1]/ngb-datepicker-month/div[2]/div[1]"
    ...
    input_Defects_WorkOrderPageAdr = "/html/body/app-root/app-main/div/div/app-manageworkorder/section/div/app-search-panel/div/div/form/div[2]/div[3]/div/span/span[1]/span/ul/li/input"
    day_1st7ColumPosition_Calendar_WorkOrderPageCol = "/html/body/app-root/app-main/div/div[1]/app-dvir/section/div/app-search-panel/div/div/div[1]/div[4]/app-date-rangepicker/div/div/ngb-datepicker/div[2]/div[1]/ngb-datepicker-month/div[7]/div[1]"

    button_EXECUTE_WorkOrderPageAdr = "/html/body/app-root/app-main/div/div[1]/app-manageworkorder/section/div/app-search-panel/div/div/form/div[2]/div[4]/div/button"
    read_Defects_WorkOrderPageAdr = "/html/body/app-root/app-main/div/div/app-manageworkorder/section/div/app-search-panel/div/div/form/div[2]/div[3]/div/span/span[1]/span/ul/li[1]"
    dropBox_Report_WorkOrderPageID = "report"
    dropBox_Categories_WorkOrderPageID = "category"
    dropBox_Defects_WorkOrderPageID = "defect"
    input_Defects_RemoveAllItems_WorkOrderPageAdr = "/html/body/app-root/app-main/div/div[1]/app-manageworkorder/section/div/app-search-panel/div/div/form/div[2]/div[3]/div/span/span[1]/span/ul/span"
    button_ACTIONSDetails_WorkOrderPageAdr = "/html/body/app-root/app-main/div/div[1]/app-manageworkorder/section[2]/div/div/div/div[2]/dx-data-grid/div/div[6]/div/div/div[1]/div/table/tbody/tr[1]/td[6]/div/div[1]/button"
    ...
    input_WorkOrderNumber_WorkOrderPageVar = ""
    month_AbreviationList = ["Jan", "Feb", "Mar", "Apr", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"]
    day_Position_Calendar_WorkOrderPageStrInit = "/html/body/app-root/app-main/div/div[1]/app-manageworkorder/section/div/app-search-panel/div/div/form/div[1]/div[4]/app-date-rangepicker/div/div/ngb-datepicker/div[2]/div[1]/ngb-datepicker-month/div["
...
#   Page Title on TCReport
    function_Name = "Work Order Manage"
...
#       Title of the right page
    ...
    while n < len(dropdown_Import_Carrier_WorkOrder_WorkOrderPage_List):
        ...
        tc_reports.write_reportfile(contol_Reportfile, print_Information_Fix, print_Information_Var, test_Case_Type, driver_Name, driver_Version)
        n = n + 1
    dropBox_Carrier_WorkOrderPageSelected = dropDown.select_by_visible_text(text_CarrierinTestVar)
    #       Status - Select %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    try:
        calendar_Line7_Colum1_WorkOrderPageAdr = day_1st7ColumPosition_Calendar_WorkOrderPageCol
        w.until(EC.element_to_be_clickable((By.XPATH, calendar_Line7_Colum1_WorkOrderPageAdr))).click()
    ...
    # ############################################################################
    dropBox_Report_PageID = dropBox_Report_WorkOrderPageID
    dropBox_Categories_PageID = dropBox_Categories_WorkOrderPageID
    dropBox_Defects_PageID = dropBox_Defects_WorkOrderPageID
    input_Defects_PageAdr = input_Defects_WorkOrderPageAdr
    read_Defects_PageAdr = read_Defects_WorkOrderPageAdr
    input_Defects_RemoveAllItems_PageAdr = input_Defects_RemoveAllItems_WorkOrderPageAdr
    source_Function = "WorkOrder"
...
#   w.until(EC.element_to_be_clickable((By.XPATH, sort_WorkOrderNumber_WorkOrderPageAdr))).click()
    try:
        w.until(EC.element_to_be_clickable((By.XPATH, "/html/body/app-root/app-main/div/div[1]/app-manageworkorder/section[2]/div/div/div/div[2]/dx-data-grid/div/div[5]/div/table/tbody/tr/td[2]"))).click()
        time.sleep(0.5)
