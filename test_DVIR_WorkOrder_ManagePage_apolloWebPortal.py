...
def DVIR_WorkOrder_ManagePage(driver, driver_Name, driver_Version, carrier, truckDriversList, driver_UserName_Var,
    ...
    box_dropBox_Drivers_DVIRPageAdr = test_Global_Addresses_apolloWebPortal.box_dropBox_Drivers_DVIRPageAdr_Global
    ...
    download_ReportNormalDVIR_DVIRPageAdr = test_Global_Addresses_apolloWebPortal.download_ReportNormalDVIR_DVIRPageAdr_Global
    driver_DVIRReport_DVIRPageAdr = test_Global_Addresses_apolloWebPortal.driver_DVIRReport_DVIRPageAdr_Global
    header_Timestamp_DVIRReport_DVIRPageAdr = test_Global_Addresses_apolloWebPortal.header_Timestamp_DVIRReport_DVIRPageAdr_Global
    sort_Timestamp_DVIRReport_DVIRPageAdr = test_Global_Addresses_apolloWebPortal.sort_Timestamp_DVIRReport_DVIRPageAdr_Global
    button_Action_ManageWorkOrder_DVIRPageAdr = test_Global_Addresses_apolloWebPortal.button_Action_ManageWorkOrder_DVIRPageAdr_Global
    button_Action_ManageWorkOrder_DVIRPageInitAdr = test_Global_Addresses_apolloWebPortal.button_Action_ManageWorkOrder_DVIRPageInitAdr_Global
    button_Action_ManageWorkOrder_DVIRPageFinalAdr = test_Global_Addresses_apolloWebPortal.button_Action_ManageWorkOrder_DVIRPageFinalAdr_Global


    title_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr = test_Global_Addresses_apolloWebPortal.title_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr_Global
    clientName_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr = test_Global_Addresses_apolloWebPortal.clientName_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr_Global
    defectList_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr = test_Global_Addresses_apolloWebPortal.defectList_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr_Global
    dropDown_DefectList_WorkOrder_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr = test_Global_Addresses_apolloWebPortal.dropDown_DefectList_WorkOrder_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr_Global
    clientAdr_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr = test_Global_Addresses_apolloWebPortal.clientAdr_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr_Global
    #Manage Work Order Page
    title_Work_Order_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr = test_Global_Addresses_apolloWebPortal. title_Work_Order_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr_Global
    input_DefectList_Work_Order_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr = test_Global_Addresses_apolloWebPortal.input_DefectList_Work_Order_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr_Global
    input_CreatedBy_Work_Order_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr = test_Global_Addresses_apolloWebPortal.input_CreatedBy_Work_Order_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr_Global
    input_Contacts_Work_Order_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr = test_Global_Addresses_apolloWebPortal.input_Contacts_Work_Order_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr_Global
    button_PlusNew_ManageWorkOrder_DVIRManageWorkOrderChildPageListAdr = test_Global_Addresses_apolloWebPortal.button_PlusNew_ManageWorkOrder_DVIRManageWorkOrderChildPageListAdr_Global
    button_X_ManageWorkOrder_WorkorderChildPageAdr = test_Global_Addresses_apolloWebPortal.button_X_ManageWorkOrder_WorkorderChildPageAdr_Global
    input_Drivers_InputField_DVIRPageAdr = test_Global_Addresses_apolloWebPortal.input_Drivers_InputField_DVIRPageAdr_Global



    # Work Orde / Manage Work Order
    input_DefectList_Work_Order_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr = test_Global_Addresses_apolloWebPortal.input_DefectList_Work_Order_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr_Global
    button_X_ManageWorkOrder_DVIRManageWorkOrderChildPageListAdr = test_Global_Addresses_apolloWebPortal.button_X_ManageWorkOrder_DVIRManageWorkOrderChildPageListAdr_Global
    driver_DVIRReport_DVIRPagetableAdr = test_Global_Addresses_apolloWebPortal.driver_DVIRReport_DVIRPagetableAdr_Global
    buttonX_WorkOrder_WorkorderChildPageAdr = test_Global_Addresses_apolloWebPortal.buttonX_WorkOrder_WorkorderChildPageAdr_Global
    button_SAVE_WorkOrder_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr = test_Global_Addresses_apolloWebPortal.button_SAVE_WorkOrder_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr_Global
    button_CLOSE_WorkOrder_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr = test_Global_Addresses_apolloWebPortal.button_CLOSE_WorkOrder_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr_Global
    #Clock
    ...
    title_DVIR_DVIRPageAdr = "/html/body/app-root/app-main/div/div[1]/breadcrumb/section/div/div/div[1]/h1"
    dropBox_Status_DVIRPageAdrID = "driversStatus"
    dropBox_Drivers_DVIRPageID = "driversSelect"
    box_dropBox_Drivers_DVIRPageAdr = "/html/body/app-root/app-main/div/div[1]/app-dvir/section/div/app-search-panel/div/div/div[1]/div[3]/div/span/span[1]/span/span[1]"
    button_Execute_DVIRPageAdr = "/html/body/app-root/app-main/div/div[1]/app-dvir/section/div/app-search-panel/div/div/div[1]/div[5]/div/button"
    download_ReportBigDVIR_DVIRPageAdr = "/html/body/app-root/app-main/div/div[1]/app-dvir/section/div/div/div/div[1]/div/button"
    download_ReportNormalDVIR_DVIRPageAdr = "/html/body/app-root/app-main/div/div[1]/app-dvir/section/div/div/div/div[2]/dx-data-grid/div/div[6]/div[1]/div/div[1]/div/table/tbody/tr[1]/td[7]/div/div/div[1]/button"
    driver_DVIRReport_DVIRPageAdr = "/html/body/app-root/app-main/div/div[1]/app-dvir/section/div/div/div/div[2]/dx-data-grid/div/div[6]/div[2]/table/tbody/tr[1]/td[1]"
    header_Timestamp_DVIRReport_DVIRPageAdr = "/html/body/app-root/app-main/div/div[1]/app-dvir/section/div/div/div/div[2]/dx-data-grid/div/div[5]/div[2]/table/tbody/tr/td[2]/div[2]"
    sort_Timestamp_DVIRReport_DVIRPageAdr = "/html/body/app-root/app-main/div/div[1]/app-dvir/section/div/div/div/div[2]/dx-data-grid/div/div[5]/div[2]/table/tbody/tr/td[2]/div[1]"


    button_Action_ManageWorkOrder_DVIRPageAdr = "/html/body/app-root/app-main/div/div[1]/app-dvir/section/div/div/div/div[2]/dx-data-grid/div/div[6]/div[1]/div/div[1]/div/table/tbody/tr[1]/td[7]/div/div/div[3]/button"
    button_Action_ManageWorkOrder_DVIRPageInitAdr = "/html/body/app-root/app-main/div/div[1]/app-dvir/section/div/div/div/div[2]/dx-data-grid/div/div[6]/div[1]/div/div[1]/div/table/tbody/tr["
    button_Action_ManageWorkOrder_DVIRPageFinalAdr = "" \
                                                     "]/td[7]/div/div/div[3]/button"
    ...
    dropDown_DefectList_WorkOrder_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr = "/html/body/ngb-modal-window[2]/div/div/app-workorder-form/div[2]/form/div[1]/div[1]/select"
    ...
    button_X_ManageWorkOrder_WorkorderChildPageAdr = "/html/body/ngb-modal-window/div/div/app-dvir-workorder/div[1]/button"
    input_Drivers_InputField_DVIRPageAdr = "/html/body/span/span/span[1]/input"
    ...
    driver_DVIRReport_DVIRPagetableAdr = "/html/body/app-root/app-main/div/div[1]/app-dvir/section/div/div/div/div[2]/dx-data-grid/div/div[6]/div[2]/table/tbody/tr[1]/td[1]"
    buttonX_WorkOrder_WorkorderChildPageAdr = "/html/body/ngb-modal-window[2]/div/div/app-workorder-form/div[1]/button"
    button_SAVE_WorkOrder_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr = "/html/body/ngb-modal-window[2]/div/div/app-workorder-form/div[2]/form/div[2]/button[1]"
    button_CLOSE_WorkOrder_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr = "/html/body/ngb-modal-window[2]/div/div/app-workorder-form/div[2]/form/div[2]/button[2]"
    #Clock
    button_calendar_StartEndDate_DVIRPageAdr = "/html/body/app-root/app-main/div/div[1]/app-dvir/section/div/app-search-panel/div/div/div[1]/div[4]/app-date-rangepicker/div/div/div/button"
    calendar_Month_DVIRPageAdr = "/html/body/app-root/app-main/div/div[1]/app-dvir/section/div/app-search-panel/div/div/div[1]/div[4]/app-date-rangepicker/div/div/ngb-datepicker/div[1]/ngb-datepicker-navigation/ngb-datepicker-navigation-select/select[1]"
    calendar_Year_DVIRPageAdr = "/html/body/app-root/app-main/div/div[1]/app-dvir/section/div/app-search-panel/div/div/div[1]/div[4]/app-date-rangepicker/div/div/ngb-datepicker/div[1]/ngb-datepicker-navigation/ngb-datepicker-navigation-select/select[2]"
    ...
    #       Drivers - Select %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    w.until(EC.element_to_be_clickable((By.XPATH, box_dropBox_Drivers_DVIRPageAdr))).click()
    input_Drivers_InputField_DVIRPage = w.until(EC.presence_of_element_located((By.XPATH, input_Drivers_InputField_DVIRPageAdr)))
    input_Drivers_InputField_DVIRPage.send_keys("qad1")
    input_Drivers_InputField_DVIRPage.send_keys(Keys.ENTER)
    ...
    #       Execute button
    w.until(EC.element_to_be_clickable((By.XPATH, button_Execute_DVIRPageAdr))).click()

    #   Sort DVIR Reports by clicking on TimeStamp icon - Select the Newest DVIR Report always
    w.until(EC.presence_of_element_located((By.XPATH, header_Timestamp_DVIRReport_DVIRPageAdr))).click()
    time.sleep(2)
    w.until(EC.element_to_be_clickable((By.XPATH, sort_Timestamp_DVIRReport_DVIRPageAdr))).click()

    #   Verify DVIR Report - Driver is corrected: ??????????????????????????????????????????????????????????????????????????????????????????????????
    driver_DVIRReport_DVIRPagetable = w.until(EC.presence_of_element_located((By.XPATH, driver_DVIRReport_DVIRPagetableAdr)))
    ...
    # Create a Work Order for each defect
    ...
    #   Client Address
    clientAdr_ManageWorkOrder_DVIRManageWorkOrderChildPageRead = w.until(EC.presence_of_element_located((By.XPATH, clientAdr_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr))).text
    ...
    #   +New button - Create Work Order based on DVIR
    ...
    try:
        ...
        dropDown = Select(w.until(EC.presence_of_element_located((By.XPATH, dropDown_DefectList_WorkOrder_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr))))
        dropDown_DefectList_Remain_WorkOrder_ManageWorkOrder_DVIRManageWorkOrderChildPage_List = [x.text for x in dropDown.options]
        print(dropDown_DefectList_Remain_WorkOrder_ManageWorkOrder_DVIRManageWorkOrderChildPage_List)

        n = 0
        for x in dropDown_DefectList_Remain_WorkOrder_ManageWorkOrder_DVIRManageWorkOrderChildPage_List:
            if x[0] != "(":
                input_DefectList_Work_Order_ManageWorkOrder_DVIRManageWorkOrderChildPage = w.until(EC.presence_of_element_located((By.XPATH, input_DefectList_Work_Order_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr)))
                input_DefectList_Work_Order_ManageWorkOrder_DVIRManageWorkOrderChildPage.send_keys(dropDown_DefectList_Remain_WorkOrder_ManageWorkOrder_DVIRManageWorkOrderChildPage_List[n])
                input_DefectList_Work_Order_ManageWorkOrder_DVIRManageWorkOrderChildPage.send_keys(Keys.RETURN)

                #   Created By
                input_CreatedBy_Work_Order_ManageWorkOrder_DVIRManageWorkOrderChildPage = w.until(EC.presence_of_element_located((By.XPATH, input_CreatedBy_Work_Order_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr)))
                input_CreatedBy_Work_Order_ManageWorkOrder_DVIRManageWorkOrderChildPage.send_keys(input_CreatedBy_Work_Order_ManageWorkOrder_DVIRManageWorkOrderChildPageVar)
                ...
                #   Contacts
                input_Contacts_Work_Order_ManageWorkOrder_DVIRManageWorkOrderChildPage = w.until(EC.presence_of_element_located((By.XPATH, input_Contacts_Work_Order_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr)))
                input_Contacts_Work_Order_ManageWorkOrder_DVIRManageWorkOrderChildPage.send_keys(input_Contacts_Work_Order_ManageWorkOrder_DVIRManageWorkOrderChildPageVar)
                input_Contacts_Work_Order_ManageWorkOrder_DVIRManageWorkOrderChildPageRead = input_Contacts_Work_Order_ManageWorkOrder_DVIRManageWorkOrderChildPage.get_attribute('value')
                ...
                #       SAVE button
                w.until(EC.element_to_be_clickable((By.XPATH, button_SAVE_WorkOrder_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr))).click()
                time.sleep(4)
                try:
                    plusNewbutton = driver.find_element(By.XPATH, button_PlusNew_ManageWorkOrder_DVIRManageWorkOrderChildPageListAdr)
                    actions = ActionChains(driver)
        ...
        w.until(EC.element_to_be_clickable((By.XPATH, button_X_ManageWorkOrder_WorkorderChildPageAdr))).click()
        w.until((EC.element_to_be_clickable((By.XPATH, button_Action_ManageWorkOrder_DVIRPageAdr)))).click()
        ...
        n = 0
        try:
            assert newDefectList_ManageWorkOrder_DVIRManageWorkOrderChildPage[0].text in \
                   defectList_ManageWorkOrder_DVIRManageWorkOrderChildPage[0].text
            ...
            #       Print Assert OK
            print_Information_Fix = "Work Order # Created from DVIR"
            print_Information_Var = newDefectList_ManageWorkOrder_DVIRManageWorkOrderChildPage[0].text
            test_Case_Type = ""
            contol_Reportfile = 1
            tc_reports.write_reportfile(contol_Reportfile, print_Information_Fix, print_Information_Var, test_Case_Type,
                                        driver_Name, driver_Version)

        title_ManageWorkOrder_DVIRManageWorkOrderChildPage = w.until(EC.presence_of_element_located((By.XPATH, title_ManageWorkOrder_DVIRManageWorkOrderChildPageAdr))).text
        test_Name = "DVIR - Manage Work Order Child page opened"
        condition1 = "Manage Work Order"
        condition2 = title_ManageWorkOrder_DVIRManageWorkOrderChildPage
        tc_reports.assert_test_reportfile(test_Name, condition1, condition2, driver, driver_Name)
