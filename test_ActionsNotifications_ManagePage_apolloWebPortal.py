...
#       Fields Address
    ...
    title_Notifications_Carrier_ManagePageAdr = test_Global_Addresses_apolloWebPortal.title_Notifications_Carrier_ManagePageAdr_Global
    button_PlussNew_Notifications_ManagePageAdr = test_Global_Addresses_apolloWebPortal.button_PlussNew_Notifications_ManagePageAdr
    input_Search_Notifications_ManagePageAdr = test_Global_Addresses_apolloWebPortal.input_Search_Notifications_ManagePageAdr_Global
    text_1stName_Notifications_ManagePageAdr = test_Global_Addresses_apolloWebPortal.text_1stName_Notifications_ManagePageAdr_Global
    text_1stType_Notifications_ManagePageAdr = test_Global_Addresses_apolloWebPortal.text_1stType_Notifications_ManagePageAdr_Global
    text_1stHomeBase_Notifications_ManagePageAdr = test_Global_Addresses_apolloWebPortal.text_1stHomeBase_Notifications_ManagePageAdr_Global
    title_Name_Notifications_ManagePageAdr = test_Global_Addresses_apolloWebPortal.title_Name_Notifications_ManagePageAdr_Global
    sort_Name_Notifications_ManagePageAdr = test_Global_Addresses_apolloWebPortal.sort_Name_Notifications_ManagePageAdr_Global
    button_Delete_Notifications_ManagePageAdr = test_Global_Addresses_apolloWebPortal.button_Delete_Notifications_ManagePageAdr_Global
    button_DeleteOK_Notifications_ManagePageAdr = test_Global_Addresses_apolloWebPortal.button_DeleteOK_Notifications_ManagePageAdr_Global
    button_SearchClean_Notifications_ManagePageAdr = test_Global_Addresses_apolloWebPortal.button_SearchClean_Notifications_ManagePageAdr_Global

    #Notification page
    title_Notification_Notifications_ManagePageAdr = test_Global_Addresses_apolloWebPortal.title_Notification_Notifications_ManagePageAdr_Global
    dropDown_HomeBase_Notification_Notifications_ManagePageAdr = test_Global_Addresses_apolloWebPortal.dropDown_HomeBase_Notification_Notifications_ManagePageAdr_Global
    input_Name_Notification_Notifications_ManagePageAdr = test_Global_Addresses_apolloWebPortal.input_Name_Notification_Notifications_ManagePageAdr_Global
    dropDown_Type_Notification_Notifications_ManagePageId = test_Global_Addresses_apolloWebPortal.dropDown_Type_Notification_Notifications_ManagePageId_Global
    input_Emails_Notification_Notifications_ManagePageAdr = test_Global_Addresses_apolloWebPortal.input_Emails_Notification_Notifications_ManagePageAdr_Global
    input_SearchAssets_Notification_Notifications_ManagePageAdr = test_Global_Addresses_apolloWebPortal.input_SearchAssets_Notification_Notifications_ManagePageAdr_Global
    checkBox_Assets_Notification_Notifications_ManagePageAdr = test_Global_Addresses_apolloWebPortal.checkBox_Assets_Notification_Notifications_ManagePageAdr_Global
    title_List_Notification_Notifications_ManagePageAdr = test_Global_Addresses_apolloWebPortal.title_List_Notification_Notifications_ManagePageAdr_Global
    checkBox_1stAsset_Notification_Notifications_ManagePageAdr = test_Global_Addresses_apolloWebPortal.checkBox_1stAsset_Notification_Notifications_ManagePageAdr_Global
    button_SAVE_Notification_Notifications_ManagePageAdr = test_Global_Addresses_apolloWebPortal.button_SAVE_Notification_Notifications_ManagePageAdr_Global
    button_CLOSE_Notification_Notifications_ManagePageAdr = test_Global_Addresses_apolloWebPortal.button_CLOSE_Notification_Notifications_ManagePageAdr_Global
    ...
    input_Search_Notifications_ManagePageAdr = "/html/body/app-root/app-main/div/div[1]/app-manage/section/div/div[2]/div/notification-list/div/div/div[2]/dx-data-grid/div/div[4]/div/div/div[3]/div/div/div/div/div[1]/input"


    text_1stName_Notifications_ManagePageAdr = "/html/body/app-root/app-main/div/div[1]/app-manage/section/div/div[2]/div/notification-list/div/div/div[2]/dx-data-grid/div/div[6]/div/table/tbody/tr[1]/td[1]"
    text_1stType_Notifications_ManagePageAdr = "/html/body/app-root/app-main/div/div[1]/app-manage/section/div/div[2]/div/notification-list/div/div/div[2]/dx-data-grid/div/div[6]/div/table/tbody/tr[1]/td[2]"
    text_1stHomeBase_Notifications_ManagePageAdr = "/html/body/app-root/app-main/div/div[1]/app-manage/section/div/div[2]/div/notification-list/div/div/div[2]/dx-data-grid/div/div[6]/div/table/tbody/tr[1]/td[3]"
    ...
    button_Delete_Notifications_ManagePageAdr = "/html/body/app-root/app-main/div/div[1]/app-manage/section/div/div[2]/div/notification-list/div/div/div[2]/dx-data-grid/div/div[6]/div/table/tbody/tr[1]/td[4]/div/button[2]"

    button_DeleteOK_Notifications_ManagePageAdr = "/html/body/ngb-modal-window/div/div/app-confirmation-dialog/div[3]/button[1]"
    button_SearchClean_Notifications_ManagePageAdr = "/html/body/app-root/app-main/div/div[1]/app-manage/section/div/div[2]/div/notification-list/div/div/div[2]/dx-data-grid/div/div[4]/div/div/div[3]/div/div/div/div/div[2]/span"
    ...
    dropDown_Type_Notification_Notifications_ManagePageId = "type"
  ...
  #   Page Title on TCReport
    ...
    #****************************************************
    #   Page Title on TCReport
    function_Name = "Create a New Notification"
    tc_reports.function_Init_Page(function_Name, driver_Name)
    ...
    while n < len(dropDown_HomeBase_Notification_Notifications_ManagePage_List):
        ...
        print_Information_Var = dropDown_HomeBase_Notification_Notifications_ManagePage_Read
        test_Case_Type = ""
        contol_Reportfile = 1
        tc_reports.write_reportfile(contol_Reportfile, print_Information_Fix, print_Information_Var, test_Case_Type, driver_Name, driver_Version)
        n = n + 1

    dropDown_HomeBase_Notification_Notifications_ManagePage_Selected = dropDown.select_by_visible_text("Home Terminal")
    dropDown_HomeBase_Notification_Notifications_ManagePage_Read = dropDown.first_selected_option.text
    ...
    input_Name_Notification_Notifications_ManagePageRead = input_Name_Notification_Notifications_ManagePage.get_property('value')
    # Assert
    test_Name = "Name"
    condition1 = input_Name_Notification_Notifications_ManagePageVar
    condition2 = input_Name_Notification_Notifications_ManagePageRead
    tc_reports.assert_test_reportfile(test_Name, condition1, condition2, driver, driver_Name)
    #       Print Assert OK
    print_Information_Fix = "Name"
    print_Information_Var = input_Name_Notification_Notifications_ManagePageRead
    test_Case_Type = ""
    contol_Reportfile = 1
    tc_reports.write_reportfile(contol_Reportfile, print_Information_Fix, print_Information_Var, test_Case_Type, driver_Name, driver_Version)
    ...
    dropDown = Select(w.until(EC.presence_of_element_located((By.ID,dropDown_Type_Notification_Notifications_ManagePageId))))
    dropDown_Type_Notification_Notifications_ManagePage_List = [x.text for x in dropDown.options]
    n = 0
    x = n + 3
    while n < len(dropDown_Type_Notification_Notifications_ManagePage_List):
        dropBox_Type_Notification_Notifications_ManagePage_Selected = dropDown.select_by_visible_text(dropDown_Type_Notification_Notifications_ManagePage_List[n])
        ...
        if dropBox_Type_Notification_Notifications_ManagePage_Read != "-- Select notification type --":
            title_List_Notification_Notifications_ManagePageRead = w.until(EC.presence_of_element_located((By.XPATH, title_List_Notification_Notifications_ManagePageAdr))).text
            excel_colum_TypeVar = (str(excel_colum_Type) + str(x))
            excel_colum_ListTitleVar = (str(excel_colum_ListTitle) + str(x))
            excel_typeVar = worksheetDB_Read[excel_colum_TypeVar].value
            excel_listTitleVar = worksheetDB_Read[excel_colum_ListTitleVar].value

            # Assert Type
            test_Name = "Notification Type"
            condition1 = dropDown_Type_Notification_Notifications_ManagePage_List[n]
            condition2 = excel_typeVar
            tc_reports.assert_test_reportfile(test_Name, condition1, condition2, driver, driver_Name)
            #       Print Assert OK
            print_Information_Fix = "Notification Type"
            print_Information_Var = dropDown_Type_Notification_Notifications_ManagePage_List[n]
            test_Case_Type = ""
            contol_Reportfile = 1
            tc_reports.write_reportfile(contol_Reportfile, print_Information_Fix, print_Information_Var, test_Case_Type, driver_Name, driver_Version)
            # Assert List based on Type
            test_Name = "Notification Type x Options Title"
            condition1 = title_List_Notification_Notifications_ManagePageRead
            condition2 = excel_listTitleVar
            tc_reports.assert_test_reportfile(test_Name, condition1, condition2, driver, driver_Name)
            #       Print Assert OK
            print_Information_Fix = "Notification Type x Options Title"
            print_Information_Var = title_List_Notification_Notifications_ManagePageRead
            test_Case_Type = ""
            contol_Reportfile = 1
            tc_reports.write_reportfile(contol_Reportfile, print_Information_Fix, print_Information_Var, test_Case_Type, driver_Name, driver_Version)
            x = x + 1
        else:
            print("Notification Test End")
        n = n + 1
    #Emails
    ...
    input_Emails_Notification_Notifications_ManagePageRead = input_Emails_Notification_Notifications_ManagePage.get_property('value')
    # Assert
    test_Name = "Name"
    condition1 = input_Emails_Notification_Notifications_ManagePageVar
    condition2 = input_Emails_Notification_Notifications_ManagePageRead
    tc_reports.assert_test_reportfile(test_Name, condition1, condition2, driver, driver_Name)
    #       Print Assert OK
    print_Information_Fix = "Name"
    print_Information_Var = input_Emails_Notification_Notifications_ManagePageRead
    test_Case_Type = ""
    contol_Reportfile = 1
    tc_reports.write_reportfile(contol_Reportfile, print_Information_Fix, print_Information_Var, test_Case_Type, driver_Name, driver_Version)
    ...
    w.until(EC.element_to_be_clickable((By.XPATH, checkBox_1stAsset_Notification_Notifications_ManagePageAdr))).click()
    #       Screenshot
    test_Name = "New Notification"
    tc_reports.screenshot(driver, driver_Name, test_Name)
    #SAVE
    ...
    #   Page Title on TCReport
    function_Name = "Verify New Notification on Notifications List page"
    tc_reports.function_Init_Page(function_Name, driver_Name)
    ...
    #   Page Title on TCReport
    function_Name = "Delete New Notification"
    tc_reports.function_Init_Page(function_Name, driver_Name)
