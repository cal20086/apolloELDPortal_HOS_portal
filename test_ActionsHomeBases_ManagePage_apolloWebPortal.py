...
def carrierHomeBases_ChildMenu_ManagePage (driver, driver_Name, driver_Version, client_Latitude_Var, client_Longitude_Var):
...
#       Fields Address
    ...
    title_HomeBases_HomeBases_ManagePageAdr = "/html/body/app-root/app-main/div/div[1]/app-manage/section/div/div[2]/div/app-homebase-list/div/div/div[1]/h3"
    button_PlussNew_HomeBases_ManagePageAdr = "/html/body/app-root/app-main/div/div[1]/app-manage/section/div/div[2]/div/app-homebase-list/div/div/div[1]/div/button"
    title_HomeBase_HomeBase_ChildPageAdr = "/html/body/app-root/app-main/div/div/app-manage/section/div/div[2]/div/app-homebase-list/div/div/div[1]/h3"
    ...
    input_Address_HomeBase_ChildPageAdr = "/html/body/ngb-modal-window/div/div/homebase-modal-form/div[2]/form/div[1]/div[2]/div[2]/div[1]/input"
    ...
    input_Search_HomeBasesAdr = "/html/body/app-root/app-main/div/div[1]/app-manage/section/div/div[2]/div/app-homebase-list/div/div/div[2]/dx-data-grid/div/div[4]/div/div/div[3]/div/div/div/div/div[1]/input"
    ...
    button_GetCoordinates_HomeBase_ChildPageAdr = "/html/body/ngb-modal-window/div/div/homebase-modal-form/div[2]/form/div[1]/div[2]/div[2]/div[2]/button"
    text_FirstName_HomeBasesPageAdr = "/html/body/app-root/app-main/div/div[1]/app-manage/section/div/div[2]/div/app-homebase-list/div/div/div[2]/dx-data-grid/div/div[6]/div[2]/table/tbody/tr[1]/td[1]"
    ...
    random = str(random)
    input_LatitudeWrong_HomeBase_ChildPageVar = "41.2852"
    input_LongitudeWrong_HomeBase_ChildPageVar = "-99.2184"

    input_LocationName_HomeBase_ChildPageVar = test_Global_Variables_apolloWebPortal.input_LocationName_HomeBase_Global
    input_Address_HomeBase_ChildPageVar = test_Global_Variables_apolloWebPortal.input_Address_HomeBase_Global
    input_Latitude_HomeBase_ChildPageVar = test_Global_Variables_apolloWebPortal.input_Latitude_HomeBase_Global
    input_Longitude_HomeBase_ChildPageVar = test_Global_Variables_apolloWebPortal.input_Longitude_HomeBase_Global
    ...
    #   Page Title on TCReport
    function_Name = "Create a NEW Home Bases"
    tc_reports.function_Init_Page(function_Name, driver_Name)
    ...
    tc_reports.write_reportfile(contol_Reportfile, print_Information_Fix, print_Information_Var, test_Case_Type, driver_Name, driver_Version)
     ...
     #   Write a Latitude Home Base Child Page test:
    input_Latitude_HomeBase_ChildPage = w.until((EC.presence_of_element_located((By.XPATH, input_Latitude_HomeBase_ChildPageAdr))))
    input_Latitude_HomeBase_ChildPage.send_keys(input_LatitudeWrong_HomeBase_ChildPageVar)
    input_Latitude_HomeBase_ChildPage.send_keys(Keys.TAB)
    time.sleep(1)
    ...
    condition1 = input_LatitudeWrong_HomeBase_ChildPageVar
    ...
    #   write a Longitude Home Base Child Page test:
    input_Longitude_HomeBase_ChildPage = w.until((EC.presence_of_element_located((By.XPATH, input_Longitude_HomeBase_ChildPageAdr))))
    input_Longitude_HomeBase_ChildPage.send_keys(input_LongitudeWrong_HomeBase_ChildPageVar)
    input_Latitude_HomeBase_ChildPage.send_keys(Keys.TAB)
    time.sleep(3)
    ...
    condition1 = input_LongitudeWrong_HomeBase_ChildPageVar
    ...
    # Button Map to set longitude and latitude
    w.until(EC.element_to_be_clickable((By.XPATH,button_GetCoordinates_HomeBase_ChildPageAdr))).click()
    time.sleep(3)
    ...
    read_Latitude_HomeBase_ChildPage = input_Latitude_HomeBase_ChildPage.get_property('value')
    #       Assert Test and print if assert is fail
    test_Name = "Google Latitude Home Base Child Page Open"
    condition1 = client_Latitude_Var
    condition2 = read_Latitude_HomeBase_ChildPage
    tc_reports.assert_test_reportfile(test_Name, condition1, condition2, driver, driver_Name)
    #       Print Assert OK
    print_Information_Fix = "Google Latitude Home Base Child Page"
    print_Information_Var = read_Latitude_HomeBase_ChildPage
    test_Case_Type = ""
    contol_Reportfile = 1
    tc_reports.write_reportfile(contol_Reportfile, print_Information_Fix, print_Information_Var, test_Case_Type, driver_Name, driver_Version)
    ...
    read_Longitude_HomeBase_ChildPage = input_Longitude_HomeBase_ChildPage.get_property('value')
    #       Assert Test and print if assert is fail
    test_Name = "Google Longitude Home Base Child Page Open"
    condition1 = client_Longitude_Var
    condition2 = read_Longitude_HomeBase_ChildPage
    tc_reports.assert_test_reportfile(test_Name, condition1, condition2, driver, driver_Name)
    #       Print Assert OK
    print_Information_Fix = "Google Longitude Home Base Child Page"
    print_Information_Var = read_Longitude_HomeBase_ChildPage
    test_Case_Type = ""
    contol_Reportfile = 1
    tc_reports.write_reportfile(contol_Reportfile, print_Information_Fix, print_Information_Var, test_Case_Type, driver_Name, driver_Version)
...
#   Select a random time zone for each test
    ...
    #   Page Title on TCReport
    function_Name = "Verify NEW Home Bases"
    tc_reports.function_Init_Page(function_Name, driver_Name)
