#               Apollo Web Portal - VIOLATIONS

def Violations_ManagePage (driver, driver_Name, driver_Version, carrier):
    ...
    title_Violation_ViolationPageAdr = test_Global_Addresses_apolloWebPortal.title_Violation_ViolationPageAdr_Global
...
#       Function Log Books side bar button click
    ...
    button_Violations_ManagePage = WebDriverWait(menuRegion_MainSideBar_ManagePageAsideDiv, 10).until(EC.element_to_be_clickable((By.XPATH, button_Violations_ManagePageAdr))).click()
    time.sleep(3)

#       Title of the right page
    title_Violation_ViolationPage = w.until(EC.presence_of_element_located((By.XPATH, title_Violation_ViolationPageAdr))).text
    test_Name = "Violations page open"
    condition1 = "Violations"
    condition2 = title_Violation_ViolationPage
    tc_reports.assert_test_reportfile(test_Name, condition1, condition2, driver, driver_Name)
    #       Print Assert OK
    print_Information_Fix = "Violations Page - Violations page open:"
    print_Information_Var = title_Violation_ViolationPage
    test_Case_Type = ""
    contol_Reportfile = 1
