...
#       Fields Address
    ...
    button_PlusNew_Carrier_ManagePageAdr = "/html/body/app-root/app-main/div/div[1]/app-manage/section/div/div[1]/div/carrier-list/div/div/div[1]/div/button"
    ...
    dropDown_CarriersName_CarriersPageAdr = "/html/body/app-root/app-main/div/div[1]/app-manage/section/div/div[1]/div/carrier-list/div/div/div[2]/table/tbody/tr/td[1]/div/select"
...
#       Variables:
    ...
    var_DOT_Number_Original_CarrierChildPage = test_Global_Variables_apolloWebPortal.var_DOT_Number_Original_Global
    var_DOT_Number_CarrierChildPage = test_Global_Variables_apolloWebPortal.var_DOT_Number_Global
    var_DOT_Number_CarrierChildPage = test_Global_Variables_apolloWebPortal.var_DOT_Number_Global
    var_CarrierName_CarrierChildPage = test_Global_Variables_apolloWebPortal.var_CarrierName_Global
    var_CarrierAddress_CarrierChildPage = test_Global_Variables_apolloWebPortal.var_CarrierAddress_Global
    var_SupportUsername_CarrierChildPage = test_Global_Variables_apolloWebPortal.var_SupportUsername_Global
    var_SupportUsername_CarrierChildPage = test_Global_Variables_apolloWebPortal.var_SupportUsername_Global
    var_SupportPassword_CarrierChildPage = test_Global_Variables_apolloWebPortal.var_SupportPassword_Global

    """
    var_DOT_Number_Oiginal_CarrierChildPage = "111111108"
    var_DOT_Number_CarrierChildPage = date.strftime("%S %f")
    var_DOT_Number_CarrierChildPage = re.sub('\W+', '', var_DOT_Number_CarrierChildPage)
    var_CarrierName_CarrierChildPage = client_Name_Var + date.strftime(" %b%d%Y %f")
    var_CarrierAddress_CarrierChildPage = client_Adress_Var
    var_SupportUsername_CarrierChildPage = "QA" + date.strftime("%b%d%Y") + date.strftime("%H:%M:%S")
    var_SupportUsername_CarrierChildPage = re.sub('\W+', '', var_SupportUsername_CarrierChildPage)
    ...
    function_Name = "Carriers Details page"
    tc_reports.function_Init_Page(function_Name, driver_Name)

    # Create a New Carrier
    w.until(EC.element_to_be_clickable((By.XPATH, button_PlusNew_Carrier_ManagePageAdr))).click()
    test_CreateCarrier_ManagePage_apolloWebPortal.createCarrier_carrierDetail_ChildMenu_ManagePage(driver, driver_Name, driver_Version, var_DOT_Number_CarrierChildPage, var_CarrierName_CarrierChildPage,
                                                                                                   var_CarrierAddress_CarrierChildPage, var_SupportUsername_CarrierChildPage, var_SupportPassword_CarrierChildPage)

    #   Page Title on TCReport
    function_Name = "Update New Carriers - Carrier Details page"
    tc_reports.function_Init_Page(function_Name, driver_Name)
    #############################################################
    # Update created Carrier

    var_CarrierName_CarrierChildPage
    #       Select new Carrier
    dropDown = Select(w.until(EC.presence_of_element_located((By.XPATH, dropDown_CarriersName_CarriersPageAdr))))
    dropDown_TimeZone_HomeBase_ChildPage = dropDown.select_by_visible_text(var_CarrierName_CarrierChildPage)
...
#   Carrier DOT field test:
    ...
    temp = input_CarrierName_CarrierChildPage.text
    ...
    input_CarrierName_CarrierChildPage.send_keys(temp)
...
#   Read the drop down list and save o the dropDown_ImportOption_CarrierCountry_CarrierChildPage_List list
    ...
    #   Support Username field test: CANNOT be changed
    try:
        ...
        read1_SupportUsername_CarrierChildPage = input_SupportUsername_CarrierChildPage.get_property('value')
        ...
        read2_SupportUsername_CarrierChildPage = input_SupportUsername_CarrierChildPage.get_property('value')
        assert read1_SupportUsername_CarrierChildPage in read2_SupportUsername_CarrierChildPage
        #       Assert Test and print if assert is fail
        test_Name = "Support Username  CANNOT be changed- Carrier Child Page"
        condition1 = read2_SupportUsername_CarrierChildPage
        condition2 = read1_SupportUsername_CarrierChildPage
        print(f'linha 245 Carrier Details    {condition1}')
        print(f'linha 245 Carrier Details    {condition2}')
        tc_reports.assert_test_reportfile(test_Name, condition1, condition2, driver, driver_Name)
        #       Print Assert OK
        print_Information_Fix = "Support Username CANNOT be changed- Carrier Child Page"
        print_Information_Var = read2_SupportUsername_CarrierChildPage
        test_Case_Type = ""
        contol_Reportfile = 1
        tc_reports.write_reportfile(contol_Reportfile, print_Information_Fix, print_Information_Var, test_Case_Type, driver_Name, driver_Version)
        #       Screenshot
        ...
        #       Print Assert OK
        print_Information_Fix = "Support Username CANNOT be changed"
...
#   Updated Information on the Carrier Child Page
    ...
    read_SupportUsername_CarrierChildPage = input_SupportUsername_CarrierChildPage.get_property('value')
    #       Assert Test and print if assert is fail
    test_Name = "Support Username CANNOT be change Update Test - Carrier Child Page"
    condition1 = read1_SupportUsername_CarrierChildPage
    condition2 = read_SupportUsername_CarrierChildPage
    tc_reports.assert_test_reportfile(test_Name, condition1, condition2, driver, driver_Name)
    #       Print Assert OK
    print_Information_Fix = "Support Username CANNOT be change Update Test - Carrier Child Page"
    print_Information_Var = read_SupportUsername_CarrierChildPage
    test_Case_Type = ""
    contol_Reportfile = 1
    tc_reports.write_reportfile(contol_Reportfile, print_Information_Fix, print_Information_Var, test_Case_Type, driver_Name, driver_Version)
