#               Apollo Web Portal - LOG EDITS

def Log_Edits_ManagePage (driver, driver_Name, driver_Version, carrier):
    ...
    button_Log_Edits_ManagePageAdr = test_Global_Addresses_apolloWebPortal.button_Log_Edits_ManagePageAdr_Global
    title_Log_Edits_Log_Edits_LogsPageAdr = test_Global_Addresses_apolloWebPortal.title_Log_Edits_Log_Edits_LogsPageAdr_Global
...
#       Function Log Books side bar button click
    ...
    button_Log_Edits_ManagePage = WebDriverWait(menuRegion_MainSideBar_ManagePageAsideDiv,10).until(EC.element_to_be_clickable((By.XPATH, button_Log_Edits_ManagePageAdr))).click()
    time.sleep(3)

#       Title of the right page
    title_Log_Edits_Log_Edits_LogsPage = w.until(EC.presence_of_element_located((By.XPATH, title_Log_Edits_Log_Edits_LogsPageAdr))).text
    test_Name = "Log Edits page open"
    condition1 = "Log Edits"
    condition2 = title_Log_Edits_Log_Edits_LogsPage
    tc_reports.assert_test_reportfile(test_Name, condition1, condition2, driver, driver_Name)
    #       Print Assert OK
    print_Information_Fix = "Log Edits Page - Log Edits page open:"
    print_Information_Var = title_Log_Edits_Log_Edits_LogsPage
    test_Case_Type = ""
    contol_Reportfile = 1
