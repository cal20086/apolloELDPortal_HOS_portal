#               Apollo Web Portal - DASHBOARD - HOURS OF SERVICE

def Dashboard_Hours_of_Service_ManagePage (driver, driver_Name, driver_Version, carrier):
    ...
    button_Hours_of_Service_ManagePageAdr = test_Global_Addresses_apolloWebPortal.button_Hours_of_Service_ManagePageAdr_Global
    title_Hours_of_Service_Hours_of_ServicePageAdr = test_Global_Addresses_apolloWebPortal.title_Hours_of_Service_Hours_of_ServicePageAdr_Global
...
#       Function Log Books side bar button click
    ...
    time.sleep(3)
    button_Hours_of_Service_ManagePage = WebDriverWait(menuRegion_MainSideBar_ManagePageAsideDiv,10).until(EC.element_to_be_clickable((By.XPATH, button_Hours_of_Service_ManagePageAdr))).click()
    time.sleep(3)
    button_Dashboards_ManagePage = WebDriverWait(menuRegion_MainSideBar_ManagePageAsideDiv, 10).until(EC.element_to_be_clickable((By.ID, button_Dashboards_ManagePageId))).click()


#       Title of the right page
    title_Hours_of_Service_Hours_of_ServicePage = w.until(EC.presence_of_element_located((By.XPATH, title_Hours_of_Service_Hours_of_ServicePageAdr))).text
    test_Name = "Hours of Service page open"
    condition1 = "HOS Dashboard"
    condition2 = title_Hours_of_Service_Hours_of_ServicePage
    tc_reports.assert_test_reportfile(test_Name, condition1, condition2, driver, driver_Name)
    #       Print Assert OK
    print_Information_Fix = "Hours of Service Page - Hours of Service page open:"
    print_Information_Var = title_Hours_of_Service_Hours_of_ServicePage
    test_Case_Type = ""
    contol_Reportfile = 1
