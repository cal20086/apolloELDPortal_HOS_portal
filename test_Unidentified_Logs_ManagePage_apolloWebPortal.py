...
def Unidentified_Logs_ManagePage (driver, driver_Name, driver_Version, carrier):
    ...
    button_Unidentified_Logs_ManagePageAdr = test_Global_Addresses_apolloWebPortal.button_Unidentified_Logs_ManagePageAdr_Global
    title_Unidentified_Logs_Unidentified_LogsPageAdr = test_Global_Addresses_apolloWebPortal.title_Unidentified_Logs_Unidentified_LogsPageAdr_Global
...
#   Page Title on TCReport
    function_Name = "Unidentified Logs"
    tc_reports.function_Init_Page(function_Name, driver_Name)



#       Function Unidentified Logs side bar button click
    ...
    button_Unidentified_Logs_ManagePage = WebDriverWait(menuRegion_MainSideBar_ManagePageAsideDiv,10).until(EC.element_to_be_clickable((By.XPATH, button_Unidentified_Logs_ManagePageAdr))).click()
    time.sleep(3)

#       Title of the right page
    title_Unidentified_Logs_Unidentified_LogsPage = w.until(EC.presence_of_element_located((By.XPATH, title_Unidentified_Logs_Unidentified_LogsPageAdr))).text
    test_Name = "Unidentified Logs page open"
    condition1 = "Unidentified Logs"
    condition2 = title_Unidentified_Logs_Unidentified_LogsPage
    tc_reports.assert_test_reportfile(test_Name, condition1, condition2, driver, driver_Name)
    #       Print Assert OK
    print_Information_Fix = "Unidentified Logs Page - Unidentified Logs page open:"
    print_Information_Var = title_Unidentified_Logs_Unidentified_LogsPage
    test_Case_Type = ""
    contol_Reportfile = 1
    ...
    print(title_Unidentified_Logs_Unidentified_LogsPage)
