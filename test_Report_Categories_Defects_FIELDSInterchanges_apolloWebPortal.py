...
#   Address
    input_ClearDefect_WorkOrderPageAdr = "/html/body/app-root/app-main/div/div/app-manageworkorder/section/div/app-search-panel/div/div/form/div[2]/div[3]/div/span/span[1]/span/ul/span"
    input_Defects_RemoveItems_PageAdr = "/html/body/app-root/app-main/div/div[1]/app-dvir/section/div/app-search-panel/div/div/div[3]/div[2]/div[3]/div/span/span[1]/span/ul/li[1]/span"
...
#                   MAIN                **********************************
    ...
    #   Check report and categories options/quantities per list based on the excel
    # Report
    ...
    # Assert
    test_Name = "Reports Items numbers"
    ...
    #       Print Assert OK
    print_Information_Fix = "Reports options available: "
    ...
    try:
        ...
        #   Read Categorie after selecting Report and compare with Excel expected value
            ...
            print_Information_Var = report_Read + " / " + categorie_Read + " / " + input_Defects_Page_Read + " => Qte of Categories available = " + str(len(dropBox_Categories_MoreFilter_List))
            test_Case_Type = ""
            contol_Reportfile = 1
            tc_reports.write_reportfile(contol_Reportfile, print_Information_Fix, print_Information_Var, test_Case_Type, driver_Name, driver_Version)
            x = x + 1
    ...
    # for combination Report/Categories/DefectsVar in range(len(excel_DefectsTypes_cellValue))
    ...
    print(f'defeitos totais celula C2 = {excel_DefectsTypes_cellValue}')
    while n < excel_DefectsTypes_cellValue:
        ...
        if cell_Parent_ID_Value == 0:
            ...
            try:
                ...
                print(f'Excell Categorie ERRO - line {x}')
            ...
            try:
                ...
                input_Defects_Page_Read = "ERRO"
            # input_Defects_Page_Read.replace(" ", "")
            input_Defects_Page_Read = input_Defects_Page_Read.replace("×", "")
            input_Defects_Page_Read = input_Defects_Page_Read.replace('\n', "")
            input_Defects_Page_Read = input_Defects_Page_Read.replace(" ", "")

            cell_Defects_Name_Value = input_Defects_Page_Read.replace("×", "")
            cell_Defects_Name_Value = input_Defects_Page_Read.replace('\n', "")
            cell_Defects_Name_Value = input_Defects_Page_Read.replace(" ", "")
            ...
            try:
                ...
                if source_Function == "WorkOrder":
                    ...
                    w.until(EC.element_to_be_clickable((By.XPATH, input_Defects_RemoveItems_PageAdr))).click()
                for x in range(41):
                    defects.send_keys(Keys.BACKSPACE)
                #Clean automatic ALL insert by portal
                defects.send_keys(Keys.BACKSPACE)
                defects.send_keys(Keys.BACKSPACE)
                defects.send_keys(Keys.BACKSPACE)
                print("Clean wrong Defect Description on field")
            ...
            tc_reports.assert_test_reportfile(test_Name, condition1, condition2, driver, driver_Name)
            #       Print Assert OK
            print_Information_Fix = "WO TEST: Report / Categories / Defect:"
            reportCategoriesDefect = str(n) + " - " + dropBox_Item_Report_Page_Read + " / " + dropBox_Item_Categories_Page_Read + " / " + cell_Defects_Name_Value
    ...
    #except:
        #print('!!!!!!!!!!!!!!!!! error  running for combination Report/Categories/DefectsVar !!!!!!!!!!!!!!!!!!!!')
